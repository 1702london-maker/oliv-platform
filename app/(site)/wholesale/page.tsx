export const metadata = {
  title: "Echthaar Extensions Großhandel Berlin — Friseure & Salons | OlivHairSupply",
  description: "BiziLuxe Echthaar Extensions im Großhandel für Salons, Stylisten & Händler. Handelskonto beantragen. Große Auswahl, Staffelpreise, schnelle EU-Lieferung aus Berlin.",
  keywords: ["Echthaar Extensions Großhandel", "Haarverlängerung Großhandel Deutschland", "Extensions Großhandel Friseure", "BiziLuxe Handelskonto", "Echthaar kaufen Großhandel Berlin"],
  openGraph: { title: "Echthaar Extensions Großhandel — OlivHairSupply Berlin", description: "Professioneller Echthaar-Großhandel für Salons & Stylisten. BiziLuxe Handelskonto beantragen.", url: "https://olivhairsupply.de/wholesale" },
  alternates: { canonical: "https://olivhairsupply.de/wholesale" }
};
