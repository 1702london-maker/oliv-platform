    ...
    <>
      ...
      <main id="ohs-account-main">
        <style>{`
          ...
          /* Logout */
          .ohs-acct-logout-form { margin-top: 8px; }
          .ohs-acct-logout-btn {
          ...
          @media (max-width: 768px) {
            ...
            .ohs-order-table-head,
            .ohs-order-row { grid-template-columns: 1fr 1fr; gap: 8px; }
            .ohs-order-ref { display: none; }
            .ohs-acct-title { font-size: 36px; }
          }
          @media (max-width: 480px) {
            .ohs-order-table-head,
            .ohs-order-row { grid-template-columns: 1fr 1fr; padding: 12px 16px; }
        ...
        <div className="ohs-acct-wrap">
          ...
          <div className="ohs-acct-profile">
            ...
            <div className="ohs-acct-profile-info">
          ...
          <div className="ohs-acct-orders">
            <div className="ohs-acct-orders-head">
              <h2>Order History</h2>
            </div>
            {orders?.length ? (
              <>
                ...
                {orders.map((order) => (
                  <div className="ohs-order-row" key={order.id}>
                    ...
                    <span
                      ...
                      style={{
                        color:
                          statusColor[order.status?.toLowerCase()] ?? "#2B2620",
                      }}
                    >
                      {order.status}
                    </span>
              ...
              <p className="ohs-orders-empty">
                ...
                <a href="/shop" style={{ color: "#B68A45", fontWeight: 600 }}>
                  Start shopping →
                </a>
              </p>
            )}
          ...
          {/* Logout */}
          <form action={logoutAction} className="ohs-acct-logout-form">
            <button className="ohs-acct-logout-btn" type="submit">
              Sign Out
            </button>
          </form>
        </div>
