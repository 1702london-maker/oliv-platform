...
function normalizeShopifyHtml(rawHtml: string, page: string) {
  ...
  html = html.replace(
    /<script\b[^>]*src=["']\/checkouts\/internal\/preloads\.js(?:\?[^"']*)?["'][^>]*>\s*<\/script>/gi,
    ""
  );
  ...
  html = html.replace(
    ...
    `<li class="ohs-ai-nav-item"><a class="ohs-nav-link ohs-ai-nav-link" href="/pages/services">Services</a><div class="ohs-ai-dropdown" style="display:none"><a href="/ai-hairmatch-pro" class="ohs-ai-dd-featured">✦ OHS AI Match</a></div></li>`
  );
